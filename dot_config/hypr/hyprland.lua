...
hl.bind(mainMod .. " + CTRL + w", hl.dsp.exec_cmd("kitty -e --class float-tui impala"))
hl.bind(mainMod .. " + CTRL + b", hl.dsp.exec_cmd("kitty -e --class float-tui bluetui"))
...
hl.bind(
	"PRINT",
	hl.dsp.exec_cmd(
		'filename="$HOME/Pictures/Screenshots/Screenshot_$(date +%Y-%m-%d_%H-%M-%S).png" && grim -g "$(slurp)" "$filename" && wl-copy < "$filename" && notify-send "Screenshot Saved & Copied" -t 2000'
	)
)
hl.bind(
	mainMod .. "+ SHIFT + v",
